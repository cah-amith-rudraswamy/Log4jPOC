...
//import org.apache.logging.log4j.core.layout.JacksonXmlRootElement;
...
public abstract class CustomJacksonLayout extends AbstractStringLayout {
	 ...
	 protected static final String DEFAULT_EOL = "\r\n";
	    ...
	    @Deprecated
	    protected CustomJacksonLayout(final Configuration config, final ObjectWriter objectWriter, final Charset charset,
	   ...
	   // @JacksonXmlRootElement(namespace = XmlConstants.XML_NAMESPACE, localName = XmlConstants.ELT_EVENT)
	    ...
	    protected static class ResolvableKeyValuePair {
	        ...
	        ResolvableKeyValuePair(KeyValuePair pair) {
	            ...
	            this.valueNeedsLookup = CustomJacksonLayout.valueNeedsLookup(this.value);
	        }
	    }
}
