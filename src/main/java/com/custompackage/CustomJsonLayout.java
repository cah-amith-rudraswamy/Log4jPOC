...
public class CustomJsonLayout extends CustomJacksonLayout {
    ...
    public static class Builder<B extends Builder<B>> extends CustomJacksonLayout.Builder<B>
    ...
    protected CustomJsonLayout(final Configuration config, final boolean locationInfo, final boolean properties,
        ...
        super(config, new CustomJacksonFactory.CustomJSON(encodeThreadContextAsList, includeStacktrace, false, false).newWriter(
    ...
    private CustomJsonLayout(final Configuration config, final boolean locationInfo, final boolean properties,
        ...
        super(config, new CustomJacksonFactory.CustomJSON(encodeThreadContextAsList, includeStacktrace, stacktraceAsString, objectMessageAsJsonObject).newWriter(
                locationInfo, properties, compact),
                charset, compact, complete, eventEol,
                PatternLayout.newSerializerBuilder().setConfiguration(config).setPattern(headerPattern).setDefaultPattern(DEFAULT_HEADER).build(),
                PatternLayout.newSerializerBuilder().setConfiguration(config).setPattern(footerPattern).setDefaultPattern(DEFAULT_FOOTER).build(),
    ...
    public static CustomJsonLayout createLayout(
        ...
        return new CustomJsonLayout(config, locationInfo, properties, encodeThreadContextAsList, complete, compact, eventEol,
